...
router.put("/update-employee", async (req, res) => {
  const { id_user, nombre, ap_paterno, ap_materno, curp_user, correo_electronico, telefono, id_estado, id_municipio, id_hospital, id_group } = req.body;
    ...
    await client.query(
      `UPDATE user_data
       SET nombre = $2,
           ...
           id_group = $11
       WHERE id_user = $1`,
      [id_user, nombre, ap_paterno, ap_materno, curp_user, correo_electronico, telefono, id_estado, id_municipio, id_hospital, id_group]
    );
