...
export default function EstadoSidebar({
  ...
  return (
    <div
      ...
      } bg-gradient-to-b from-blue-800 to-blue-900 text-white transition-all duration-200 flex flex-col h-screen fixed z-30`}
        ...
        <div className="space-y-1">
          {options.map(({ label, icon, tab }) => (
            <button
              ...
              className={`flex items-center py-3 px-4 hover:bg-blue-700 transition-colors duration-200 w-full rounded-md ${
